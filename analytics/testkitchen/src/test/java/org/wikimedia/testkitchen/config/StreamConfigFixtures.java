...
import static org.wikimedia.testkitchen.config.StreamConfigFetcher.METRICS_PLATFORM_SCHEMA_TITLE;
import static org.wikimedia.testkitchen.context.ContextValue.AGENT_APP_INSTALL_ID;
import static org.wikimedia.testkitchen.context.ContextValue.AGENT_APP_FLAVOR;
import static org.wikimedia.testkitchen.context.ContextValue.AGENT_APP_THEME;
import static org.wikimedia.testkitchen.context.ContextValue.AGENT_APP_VERSION;
import static org.wikimedia.testkitchen.context.ContextValue.AGENT_DEVICE_LANGUAGE;
import static org.wikimedia.testkitchen.context.ContextValue.AGENT_RELEASE_STATUS;
import static org.wikimedia.testkitchen.context.ContextValue.AGENT_CLIENT_PLATFORM;
import static org.wikimedia.testkitchen.context.ContextValue.AGENT_CLIENT_PLATFORM_FAMILY;
import static org.wikimedia.testkitchen.context.ContextValue.MEDIAWIKI_DATABASE;
import static org.wikimedia.testkitchen.context.ContextValue.PAGE_TITLE;
import static org.wikimedia.testkitchen.context.ContextValue.PAGE_ID;
import static org.wikimedia.testkitchen.context.ContextValue.PAGE_NAMESPACE_ID;
import static org.wikimedia.testkitchen.context.ContextValue.PAGE_WIKIDATA_QID;
import static org.wikimedia.testkitchen.context.ContextValue.PERFORMER_SESSION_ID;
import static org.wikimedia.testkitchen.context.ContextValue.PERFORMER_PAGEVIEW_ID;
import static org.wikimedia.testkitchen.context.ContextValue.PERFORMER_LANGUAGE_GROUPS;
import static org.wikimedia.testkitchen.context.ContextValue.PERFORMER_LANGUAGE_PRIMARY;
import static org.wikimedia.testkitchen.curation.CurationFilterFixtures.curationFilter;
