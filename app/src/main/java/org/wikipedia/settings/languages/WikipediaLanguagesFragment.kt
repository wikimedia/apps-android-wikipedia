...
class WikipediaLanguagesFragment : Fragment(), WikipediaLanguagesItemView.Callback {
    ...
    override fun onDestroyView() {
        funnel.logLanguageSetting(invokeSource, initialLanguageList, JsonUtil.encodeToString(app.appLanguageState.appLanguageCodes).orEmpty(), interactionsCount, isLanguageSearched)
