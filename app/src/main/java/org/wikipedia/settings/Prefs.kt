...
object Prefs {
    ...
    var editHistoryFilterDisableSet
        get() = JsonUtil.decodeFromString<Set<String>>(PrefsIoUtil.getString(R.string.preference_key_edit_history_filter_disable_set, null))
            ?: emptySet()
        set(filterDisableSet) = PrefsIoUtil.setString(R.string.preference_key_edit_history_filter_disable_set, JsonUtil.encodeToString(filterDisableSet))
}
