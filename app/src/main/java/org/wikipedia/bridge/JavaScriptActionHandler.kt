...
object JavaScriptActionHandler {
    ...
    fun mobileWebChromeShim(): String {
        return "(function() {" +
                ...
                "style.innerHTML = '.header-chrome { visibility: hidden; margin-top: 48px; height: 0px; } #page-secondary-actions { display: none; } .mw-footer { margin-bottom: 48px; } .page-actions-menu { display: none; } .minerva__tab-container { display: none; }';" +
