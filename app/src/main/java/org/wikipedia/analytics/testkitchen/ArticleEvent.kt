...
class ArticleFindInPageInteraction(private val fragment: PageFragment) : TimedEvent() {
...
class ArticleToolbarInteraction(private val fragment: PageFragment) : TimedEvent() {
...
class ArticleTocInteraction(private val fragment: PageFragment, private val numSections: Int) : Event() {
...
open class ArticleLinkPreviewInteraction : TimedEvent {
