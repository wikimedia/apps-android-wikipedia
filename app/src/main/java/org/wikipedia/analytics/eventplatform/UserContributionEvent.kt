...
@Serializable
@SerialName("/analytics/mobile_apps/android_user_contribution_screen/3.1.0")
class UserContributionEvent(val action: String) : MobileAppsEventWithTemp(STREAM_NAME) {
