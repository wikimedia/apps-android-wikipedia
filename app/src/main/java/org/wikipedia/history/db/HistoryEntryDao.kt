...
interface HistoryEntryDao {
    ...
    suspend fun getDistinctEntriesCountBetween(startDate: Long, endDate: Long = System.currentTimeMillis()): Int
    ...
    @Query("SELECT displayTitle FROM HistoryEntry WHERE timestamp BETWEEN :startDate AND :endDate GROUP BY displayTitle ORDER BY COUNT(displayTitle) DESC LIMIT :limit")
    suspend fun getTopVisitedEntriesBetween(limit: Int, startDate: Long, endDate: Long = System.currentTimeMillis()): List<String>
    ...
    suspend fun getFavoriteTimeToReadBetween(startDate: Long, endDate: Long = System.currentTimeMillis()): Int?
    ...
    suspend fun getFavoriteDayToReadBetween(startDate: Long, endDate: Long = System.currentTimeMillis()): Int?
    ...
    suspend fun getMostReadingMonthBetween(startDate: Long, endDate: Long = System.currentTimeMillis()): Int?
