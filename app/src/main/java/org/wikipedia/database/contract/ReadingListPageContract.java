...
public interface ReadingListPageContract {
    ...
    interface Col {
        ...
        StrColumn REQUEST_URL_TITLE = new StrColumn(TABLE, "readingListRequestUrlTitle", "string"); // the "original" title, especially for the Chinese variants
        ...
        String[] ALL = DbUtil.qualifiedNames(ID, LISTID, SITE, LANG, NAMESPACE, TITLE, REQUEST_URL_TITLE, MTIME, ATIME,
