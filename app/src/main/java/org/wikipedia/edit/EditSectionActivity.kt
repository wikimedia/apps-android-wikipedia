...
class EditSectionActivity : BaseActivity(), ThemeChooserDialog.Callback {
    ...
    private var diffItems: List<DiffResponse.DiffItem>? = null
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // For undo editing
        diffItems = JsonUtil.decodeFromString(intent.getStringExtra(EXTRA_DIFF_ITEMS))
    ...
    companion object {
        ...
        const val EXTRA_DIFF_ITEMS = "org.wikipedia.edit_section.diffitems"
        ...
        fun newIntent(context: Context, diffItems: String, title: PageTitle, revisionId: Long, revisionIdAfter: Long): Intent {
            return Intent(context, EditSectionActivity::class.java)
                .putExtra(EXTRA_DIFF_ITEMS, diffItems)
                .putExtra(EXTRA_TITLE, title)
