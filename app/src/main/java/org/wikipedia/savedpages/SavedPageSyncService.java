...
public class SavedPageSyncService extends JobIntentService {
    ...
    private long savePageFor(@NonNull ReadingListPage page) throws Exception {
        ...
        Observable.zip(leadCall, sectionsCall, mediaCall, (leadRsp, sectionsRsp, mediaList) -> {
            long totalSize = 0;
    ...
    private long reqSaveMedia(@NonNull ReadingListPage page, @NonNull Set<String> urls) throws IOException, InterruptedException {
        ...
        for (String url : urls) {
            ...
            try {
                totalSize += reqSaveMedia(page.wiki(), url);
    ...
    private long reqSaveMedia(@NonNull WikiSite wiki, @NonNull String url) throws IOException {
