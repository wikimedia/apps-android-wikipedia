...
object OkHttpConnectionFactory {
    private val CACHE_DIR_NAME = "okhttp-cache"
    private val NET_CACHE_SIZE = (64 * 1024 * 1024).toLong()
    private val NET_CACHE = Cache(File(WikipediaApp.getInstance().cacheDir,
            CACHE_DIR_NAME), NET_CACHE_SIZE)
    private val SAVED_PAGE_CACHE_SIZE = NET_CACHE_SIZE * 1024
    val SAVE_CACHE = CacheDelegate(Cache(File(WikipediaApp.getInstance().filesDir,
