...
public interface Service {
    ...
    @GET(REST_API_PREFIX + "page/mobile-sections-lead/{title}")
    @NonNull Call<RbPageLead> getLeadSection(@Nullable @Header("Cache-Control") String cacheControl,
    ...
    @GET(REST_API_PREFIX + "page/mobile-sections-remaining/{title}")
    ...
    @Headers("Cache-Control: no-cache")
    @POST(REST_API_PREFIX + "data/lists/{id}/entries/batch")
    ...
    @Headers("Cache-Control: no-cache")
    @DELETE(REST_API_PREFIX + "data/lists/{id}/entries/{entry_id}")
