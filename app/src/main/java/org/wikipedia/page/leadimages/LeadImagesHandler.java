                ...
                .subscribe(captions -> {
                            ...
                            if (galleryItem[0] != null) {
                                ...
                                if (!captions.containsKey(getTitle().getWikiSite().languageCode())) {
                                    pageHeaderView.setUpCallToAction(String.format(app.getResources().getString(R.string.suggested_edits_article_cta_image_caption), app.language().getAppLanguageLocalizedName(getTitle().getWikiSite().languageCode())));
                                    ...
                                    for (String lang : app.language().getAppLanguageCodes()) {
                                        if (!captions.containsKey(lang)) {
                                            ...
                                            callToActionTargetSummary = new SuggestedEditsSummary(captionTargetPageTitle.getPrefixedText(), captionTargetPageTitle.getWikiSite().languageCode(), captionTargetPageTitle,
                                                    ...
                                                    null, null, null, null);
                                            pageHeaderView.setUpCallToAction(String.format(app.getResources().getString(R.string.suggested_edits_article_cta_image_caption), app.language().getAppLanguageLocalizedName(lang)));
                                            break;
                                        }
                                    }
                                }
