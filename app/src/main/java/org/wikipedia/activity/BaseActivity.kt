...
import org.wikipedia.games.onthisday.OnThisDayGameOverFragment
...
abstract class BaseActivity : AppCompatActivity(), ConnectionStateMonitor.Callback {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK && data?.hasExtra(OnThisDayGameOverFragment.EXTRA_GAME_COMPLETED) == true) {
            OnThisDayGameOverFragment.maybeShowOnThisDayGameEndContent(this)
        }
    }
