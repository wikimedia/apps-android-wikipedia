    ...
    private fun maybeShowTooltipSequence() {
        binding.root.post {
            ...
            if (Prefs.shouldShowImageRecsOnboarding()) {
                ...
                val balloon = FeedbackUtil.getTooltip(requireContext(), getString(R.string.image_recommendations_tooltip1), autoDismiss = false, showDismissButton = true)
                balloon.showAlignBottom(binding.articleTitlePlaceholder)
                balloon.relayShowAlignBottom(FeedbackUtil.getTooltip(requireContext(), getString(R.string.image_recommendations_tooltip2), autoDismiss = false, showDismissButton = true), binding.instructionText)
                        .relayShowAlignBottom(FeedbackUtil.getTooltip(requireContext(), getString(R.string.image_recommendations_tooltip3), autoDismiss = false, showDismissButton = true), binding.acceptButton)
            } else {
