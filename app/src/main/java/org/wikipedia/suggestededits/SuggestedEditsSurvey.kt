...
object SuggestedEditsSurvey {
    ...
    fun maybeRunSurvey(activity: Activity) {
        if (Prefs.shouldShowSuggestedEditsSurvey) {
            ...
            snackbar.show()
            Prefs.shouldShowSuggestedEditsSurvey = false
        }
    }
    ...
    fun onEditSuccess() {
        ...
        if (Prefs.suggestedEditsCountForSurvey == 1 ||
            ...
            !Prefs.isSuggestedEditsSurveyClicked) {
            Prefs.shouldShowSuggestedEditsSurvey = true
        }
    }

    private fun openSurveyInBrowser() {
        Prefs.isSuggestedEditsSurveyClicked = true
