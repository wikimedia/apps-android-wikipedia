...
class SuggestedEditsImageRecsOnboardingActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        onboardingView.setSecondaryText(getString(R.string.image_recommendation_onboarding_secondary,
            getString(R.string.image_recommendation_onboarding_2), getString(R.string.image_recommendation_onboarding_3)))
