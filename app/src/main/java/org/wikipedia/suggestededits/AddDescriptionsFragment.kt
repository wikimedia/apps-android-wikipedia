...
import org.wikipedia.suggestededits.AddDescriptionsActivity.Companion.EXTRA_SOURCE
import org.wikipedia.suggestededits.AddDescriptionsActivity.Companion.EXTRA_SOURCE_ADDED_DESCRIPTION
import org.wikipedia.util.AnimationUtil
import org.wikipedia.util.FeedbackUtil
import org.wikipedia.util.log.L

class AddDescriptionsFragment : Fragment() {
    ...
    private val topChild: AddDescriptionsItemFragment?
        get() {
            ...
            for (f in fm!!.fragments) {
                if (f is AddDescriptionsItemFragment && f.pagerPosition == addTitleDescriptionsItemPager.currentItem) {
                    return f
                }
            }
            return null
    ...
    private class ViewPagerAdapter internal constructor(activity: AppCompatActivity): FragmentStatePagerAdapter(activity.supportFragmentManager) {
        ...
        override fun getItem(position: Int): Fragment {
            val f = AddDescriptionsItemFragment.newInstance()
    ...
    companion object {
        fun newInstance(source: InvokeSource): AddDescriptionsFragment {
            val addTitleDescriptionsFragment = AddDescriptionsFragment()
            val args = Bundle()
