...
open class FeaturedTopicCardView(context: Context) : DefaultFeedCardView<TopicCard>(context) {
    ...
    override var card: TopicCard? = null
        set(value) {
            field = value
            value?.let {
    ...
    private fun header(card: TopicCard) {
