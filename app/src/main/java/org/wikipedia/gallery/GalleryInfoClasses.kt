...
class ImageInfo(
    ...
    @Json(name = "short_name") internal val shortName: String? = null,
    @Json(name = "descriptionshorturl") internal val descriptionShortUrl: String? = null,
    internal val derivatives: List<Derivative> = emptyList(),
