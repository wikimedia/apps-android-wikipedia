...
class NotificationPollBroadcastReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        when {
            ...
            ACTION_POLL == intent.action -> {
                ...
                if (!Prefs.isNotificationPollEnabled) {
                    return
                }
                ...
                LOCALLY_KNOWN_NOTIFICATIONS = Prefs.locallyKnownNotifications
    ...
    companion object {
        ...
        private var LOCALLY_KNOWN_NOTIFICATIONS = Prefs.locallyKnownNotifications
