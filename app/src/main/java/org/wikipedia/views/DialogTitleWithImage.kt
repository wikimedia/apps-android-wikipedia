...
class DialogTitleWithImage(context: Context, @StringRes titleRes: Int, @DrawableRes imageRes: Int, private val preserveImageAspect: Boolean) : LinearLayout(context) {
