...
public class PageActionOverflowView extends FrameLayout {
    ...
    @OnClick({R.id.overflow_forward, R.id.overflow_find_in_page, R.id.overflow_new_tab,
            R.id.overflow_share, R.id.overflow_feed, R.id.page_action_overflow_categories})
    void onItemClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.overflow_feed:
                callback.feedClick();
                break;
            case R.id.page_action_overflow_categories:
