...
public class CreateAccountClientTest extends MockRetrofitTest {
    ...
    @Test public void testRequestSuccess() throws Throwable {
        ...
        getObservable().test().await()
                ...
                .assertValue(result -> result.getCreateAccount().getStatus().equals("PASS")
                        && result.getCreateAccount().getUsername().equals("Farb0nucci"));
    }
    ...
    @Test public void testRequestFailure() throws Throwable {
        ...
        getObservable().test().await()
                .assertComplete().assertNoErrors()
                .assertValue(result -> result.getCreateAccount().getStatus().equals("FAIL"));
    }
