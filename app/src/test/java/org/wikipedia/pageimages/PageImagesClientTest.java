...
public class PageImagesClientTest extends MockWebServerTest {
    ...
    @Test public void testRequestSuccess() throws Throwable {
        ...
        Call<MwQueryResponse<PageImagesClient.QueryResult>> call = request(cb);
    ...
    private void assertCallbackFailure(@NonNull Call<MwQueryResponse<PageImagesClient.QueryResult>> call,
    ...
    private Call<MwQueryResponse<PageImagesClient.QueryResult>> request(@NonNull PageImagesClient.Callback cb) {
