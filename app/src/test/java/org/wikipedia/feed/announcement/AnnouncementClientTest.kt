...
class AnnouncementClientTest : MockRetrofitTest() {
    ...
    fun testShouldShowByCountry() {
        ...
        val dateDuring = LocalDate(2016, 11, 20).atStartOfDayIn(TimeZone.currentSystemDefault())
    ...
    fun testShouldShowByDate() {
        val announcement = announcementList.items[ANNOUNCEMENT_SURVEY_ANDROID]
        val dateBefore = LocalDate(2016, 8, 1).atStartOfDayIn(TimeZone.currentSystemDefault())
        val dateAfter = LocalDate(2017, 1, 5).atStartOfDayIn(TimeZone.currentSystemDefault())
