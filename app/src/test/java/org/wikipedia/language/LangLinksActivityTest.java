...
public class LangLinksActivityTest{
    ...
    @Test public void testAddChineseEntriesForTraditionalChinese() {
        ...
        LangLinksViewModel.addVariantEntriesIfNeeded(WikipediaApp.Companion.getInstance().getLanguageState(), title, list);
    ...
    private List<PageTitle> getExpectedZhHantResults() {
        ...
        List<String> variants = WikipediaApp.Companion.getInstance().getLanguageState().getLanguageVariants("zh");
        if (variants != null) {
