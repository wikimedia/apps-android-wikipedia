...
public class WikitextClientTest extends MockRetrofitTest {
    ...
    @Test public void testRequestSuccessHasResults() throws Throwable {
        ...
        getObservable().test().await()
                ...
                .assertValue(response -> response.getQuery().firstPage().getRevisions().get(0).getContent().equals("\\o/\n\ntest12\n\n3")
                        && response.getQuery().firstPage().getRevisions().get(0).getTimeStamp().equals("2018-03-18T18:10:54Z"));
    }
