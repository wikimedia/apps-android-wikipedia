...
class WikitextClientTest : MockRetrofitTest() {
    ...
    fun testRequestSuccessHasResults() {
        ...
        observable.test().await()
            ...
            .assertValue {
                    response -> response.query!!.firstPage()!!.revisions[0].contentMain == "\\o/\n\ntest12\n\n3" &&
                    response.query!!.firstPage()!!.revisions[0].localDateTime == DateUtil.iso8601LocalDateTimeParse("2018-03-18T18:10:54Z")
            }
    }
